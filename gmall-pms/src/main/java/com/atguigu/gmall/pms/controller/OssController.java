...
public class OssController {
    ...
    public ResponseVo<Object> policy(){
        String accessId = "LTAI5tE285tMbTGvArGTGacn"; // 请填写您的AccessKeyId。
        String accessKey = "YkN8HfitmbK9IoAtdLTYAqR2jBERV2"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "shuidongliu9527"; // 请填写您的 bucketname 。
